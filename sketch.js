...
function preload(){
  ...
  trex_running = loadAnimation("playerRed_walk1.png","playerRed_walk2.png");
  trex_collided = loadAnimation("playerRed_dead.png");
  ...
  bg  = loadImage("rm222-mind-22_1_2.jpg");
}
...
function setup() {
  ...
  invisibleGround = createSprite(displayWidth/2,182,400,10);
